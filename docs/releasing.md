...
| Context | Example |
|---------|---------|
| Git tag / `FK_VERSION_NAME` | `0.1.3` (no `v` prefix) |
| JitPack (open source, recommended now) | `com.github.feng-zhang0712.fk-android:business:0.1.3` |
| Maven Central (planned) | `com.fk.android:business:0.1.3` |
| GitHub Packages | `com.fk.android:business:0.1.3` (auth often required to download) |
...
git tag -a 0.1.3 -m "Release 0.1.3"
