...
private fun SampleNavHost() {
  ...
  NavHost(
    ...
    composable(SampleDestination.TOAST) {
      ToastDemoScreen(onBack = { navController.popBackStack() })
    }
    ...
    composable(SampleDestination.FLOW) {
      FlowDemoScreen(onBack = { navController.popBackStack() })
    }
