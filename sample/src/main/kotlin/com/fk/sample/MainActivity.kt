...
class MainActivity : ComponentActivity() {
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    val session = MockUserSession(initiallyAuthenticated = false)
    ...
    val logger = MockPluggableLogger()
    ...
    setContent {
      FkTheme {
        ...
        var storedNote by remember { mutableStateOf(storage.get("demo.note", String.serializer()) ?: "(empty)") }
        ...
        Column(
          ...
          Text("fk-android sample", style = MaterialTheme.typography.headlineSmall)
